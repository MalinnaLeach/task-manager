...
it("creates a list of tasks with tags", () => {
  ...
  expect(result.props.children[2][0].props.description).toEqual('Domain Modelling');
  expect(result.props.children[2][0].props.tags).toEqual([{"id":3,"name":"Coding"}]);
  expect(result.props.children[2].length).toEqual(2);
});
